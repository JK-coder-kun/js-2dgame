...
export class Jumping extends State{
    ...
    handleInput(input){
        ...
        else if(input.includes('ArrowDown')) this.game.player.setState(states.DIVDING,0);
    }
}
...
export class Falling extends State{
    ...
    enter(){
        if(this.game.player.onGround()) this.vy -=20;
        this.game.player.frameX = 0;
...
export class Rolling extends State{
    ...
    handleInput(input){
        this.game.particles.unshift(new Fire(this.game,this.game.player.x+this.game.player.width*0.2,this.game.player.y+this.game.player.height*0.5));
        ...
        }else if(input.includes('ArrowDown') && !this.game.player.onGround()) this.game.player.setState(states.DIVDING,0);
...
export class Diving extends State{
    ...
    handleInput(input){
        ...
        else if(input.includes('Enter') && this.game.player.onGround()) this.game.player.setState(states.ROLLING,1);
